<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:72:"D:\phpStudy\WWW\ershoushouji/public\theme\admin\basedata\banner_add.html";i:1510311210;s:66:"D:\phpStudy\WWW\ershoushouji/public\theme\admin\layout\layout.html";i:1508488281;s:66:"D:\phpStudy\WWW\ershoushouji/public\theme\admin\layout\static.html";i:1500431396;s:62:"D:\phpStudy\WWW\ershoushouji/public\theme\admin\layout\js.html";i:1500431396;}*/ ?>
<!DOCTYPE html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no"><meta name="renderer" content="webkit"><title><?php echo $admin_title; ?></title><meta name="keywords" content=""><meta name="description" content=""><!-- 引入公共css/js --><!-- 字体图标 --><link rel="shortcut icon" href="<?php echo $web_public; ?>favicon.ico"><link href="<?php echo $web_static; ?>/css/font-awesome.min.css" rel="stylesheet"><!-- JQuery --><script src="<?php echo $web_static; ?>/js/jquery.min.js"></script><script src="<?php echo $web_static; ?>/plugins/metisMenu/jquery.metisMenu.js"></script><!-- bootstrap --><link href="<?php echo $web_static; ?>/plugins/bootstrap/css/bootstrap.min.css" rel="stylesheet"><script src="<?php echo $web_static; ?>/plugins/bootstrap/js/bootstrap.min.js"></script><!-- 自定义样式 --><link href="<?php echo $css; ?>/animate.css" rel="stylesheet"><link href="<?php echo $css; ?>/style.css" rel="stylesheet"><!-- checkbox 和radio 美化 --><link href="<?php echo $web_static; ?>/css/input.css" rel="stylesheet"><!-- <link href="<?php echo $web_static; ?>/css/checkbox.css" rel="stylesheet"><script src="<?php echo $web_static; ?>/js/checkbox.js"></script> --><!-- select 美化 --><link href="<?php echo $web_static; ?>/css/select.css" rel="stylesheet"><link href="<?php echo $web_static; ?>/plugins/jquery/scrollbar.css" rel="stylesheet"><script src="<?php echo $web_static; ?>/plugins/jquery/scrollbar.js"></script><script src="<?php echo $web_static; ?>/js/select.js"></script><link href="<?php echo $web_static; ?>/css/common.css" rel="stylesheet"><link href="<?php echo $web_static; ?>/plugins/editor/wangEditor.min.css" rel="stylesheet"><style>        .layout-return-btn{
    ...
    </style></head><body class="gray-bg  animated fadeIn"><div class="wrapper wrapper-content ibox float-e-margins" ><div class="ibox-title visible-lg"><!-- <h5> --><ul class="breadcrumb inline pull-left" ><li><?php echo $menu['pmenu']; ?></li><li><?php echo $menu['menu_name']; ?></li></ul><!-- </h5> --><a class="pull-right btn btn-default btn-xs" title="刷新当前" href=""><i class="fa fa-refresh"></i></a></div><div class="ibox-content"><script src="<?php echo $web_static; ?>/js/uploadImg.js"></script><form class="form-horizontal js-ajax-form clearfix" action="<?php echo U('banner_add'); ?>"><input type="hidden" name="id" value="<?php echo isset($banner) ? $banner['id'] : ''; ?>"><div class="form-group"><label class="col-sm-2 control-label">标题</label><div class="col-sm-4"><input type="text" name="title" value="<?php echo isset($banner) ? $banner['title'] : ''; ?>" class="form-control" placeholder="标题"></div></div><div class="form-group"><label class="col-sm-2 control-label">类型</label><div class="col-sm-4"><select   class="form-control"  name="type_id" id="sel_type"><option value="">请选择类型</option><?php if(is_array($types) || $types instanceof \think\Collection || $types instanceof \think\Paginator): $i = 0; $__LIST__ = $types;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option value="<?php echo $v['id']; ?>" <?php if(isset($banner) && $banner['type_id'] ==$v['id']): ?>selected<?php endif; ?>><?php echo $v['type_name']; ?></option><?php endforeach; endif; else: echo "" ;endif; ?></select></div></div><div class="form-group"><label class="col-sm-2 control-label">状态</label><div class="col-sm-4"><label class="i-lab"><input type="radio" name="is_using" value='Y' <?php if(isset($banner) && $banner['is_using'] == 'Y'): ?>checked="checked"<?php endif; ?> class="mgr mgr-primary  mgr-lg" checked><span>启用</span></label><label class="i-lab"><input type="radio" name="is_using" value='N' <?php if(isset($banner) && $banner['is_using'] == 'N'): ?>checked="checked"<?php endif; ?> class="mgr mgr-primary mgr-lg" ><span>禁用</span></label></div></div><div class="form-group"><label class="col-sm-2 control-label">排序</label><div class="col-sm-4"><input type="text" name="rank" value="<?php echo isset($banner) ? $banner['rank'] : ''; ?>" class="form-control" id="rank" placeholder="排序"></div></div><?php if(!empty($banner['banner'])): ?><div class="form-group"><label class="col-sm-2 control-label">原banner图</label><div class="img_cont"><img src="__UPLOAD__<?php echo $banner['banner']; ?>"></div></div><div class="form-group"><label class="col-sm-2 control-label">修改banner图</label><div class="img_cont"><div class="img_prev"></div><input type="file" name="banner" id="edit_banner"  value=""/></div></div><?php else: ?><div class="form-group"><label class="col-sm-2 control-label">banner图</label><div class="img_cont"><div class="img_prev"></div><input type="file" name="banner" id="banner"  value=""/></div></div><?php endif; ?><div class="form-group"><label class="col-sm-2 control-label"></label><div class="col-sm-4"><button type="submit" class="btn btn-primary js-submit-btn mr_3px">确认</button><button type="reset" class="btn btn-primary">重置</button></div></div></form><script type="text/javascript">    $(function(){
        $('#sel_type').change(function(){
            var type_id = $(this).children('option:selected').val();
            $.post("<?php echo url('basedata/getRank'); ?>",{'type_id':type_id},function(res){
                if(res.status){
