<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:65:"D:\phpStudy\WWW\ershoushouji/public\theme\admin\orders\index.html";i:1505795024;s:66:"D:\phpStudy\WWW\ershoushouji/public\theme\admin\layout\layout.html";i:1500431397;s:66:"D:\phpStudy\WWW\ershoushouji/public\theme\admin\layout\static.html";i:1500431396;s:62:"D:\phpStudy\WWW\ershoushouji/public\theme\admin\layout\js.html";i:1500431396;}*/ ?>
<!DOCTYPE html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no"><meta name="renderer" content="webkit"><title><?php echo $admin_title; ?></title><meta name="keywords" content=""><meta name="description" content=""><!-- 引入公共css/js --><!-- 字体图标 --><link rel="shortcut icon" href="<?php echo $web_public; ?>favicon.ico"><link href="<?php echo $web_static; ?>/css/font-awesome.min.css" rel="stylesheet"><!-- JQuery --><script src="<?php echo $web_static; ?>/js/jquery.min.js"></script><script src="<?php echo $web_static; ?>/plugins/metisMenu/jquery.metisMenu.js"></script><!-- bootstrap --><link href="<?php echo $web_static; ?>/plugins/bootstrap/css/bootstrap.min.css" rel="stylesheet"><script src="<?php echo $web_static; ?>/plugins/bootstrap/js/bootstrap.min.js"></script><!-- 自定义样式 --><link href="<?php echo $css; ?>/animate.css" rel="stylesheet"><link href="<?php echo $css; ?>/style.css" rel="stylesheet"><!-- checkbox 和radio 美化 --><link href="<?php echo $web_static; ?>/css/input.css" rel="stylesheet"><!-- <link href="<?php echo $web_static; ?>/css/checkbox.css" rel="stylesheet"><script src="<?php echo $web_static; ?>/js/checkbox.js"></script> --><!-- select 美化 --><link href="<?php echo $web_static; ?>/css/select.css" rel="stylesheet"><link href="<?php echo $web_static; ?>/plugins/jquery/scrollbar.css" rel="stylesheet"><script src="<?php echo $web_static; ?>/plugins/jquery/scrollbar.js"></script><script src="<?php echo $web_static; ?>/js/select.js"></script><link href="<?php echo $web_static; ?>/css/common.css" rel="stylesheet"><link href="<?php echo $web_static; ?>/plugins/editor/wangEditor.min.css" rel="stylesheet"><style>        .layout-return-btn{
        ...
        body{
            ...
            </a></div><div class="pull-right"><?php echo $lists->render(); ?></div></div></div><div class="table-responsive"><table class="table table-hover table-bordered table-condensed"><thead><tr><th width='1'><input type="checkbox" class="i-checks i-check-all my-all-check" id="all" name="input[]"></th><th width="200">订单编号</th><th width="150" class="hidden-xs">昵称</th><th width="150" class="hidden-xs">手机号</th><th width="100" class="hidden-xs">商品</th><th width="100" class="hidden-xs">价格</th><th width="100" class="hidden-xs">付款方式</th><th width="100" class="hidden-xs">状态</th><th width="100" class="hidden-xs">下单时间</th><th width="150">操作</th></tr></thead><tbody id="list"><?php if(is_array($lists) || $lists instanceof \think\Collection || $lists instanceof \think\Paginator): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr><td width='1'><input type="checkbox" class="i-checks" name="input[]" value="<?php echo $vo['order_id']; ?>"></td><td><?php echo $vo['order_sn']; ?></td><td><?php echo $vo['user_info']['nickname']; ?></td><td><?php echo $vo['user_info']['phone']; ?></td><?php if($vo['order_info1']): ?><td><?php echo $vo['order_info1']['goods_name']; ?></td><td><?php echo $vo['order_info1']['price']; ?></td><?php else: ?><td>--</td><td>--</td><?php endif; ?><td><?php echo $vo['paytype']; ?></td><td><?php echo $vo['status_name']; ?></td><td><?php echo $vo['create_time']; ?></td><td ><span class="btn-group"><a href="<?php echo U('Orders/order_detail',['order_id'=>$vo['order_id']]); ?>" class="btn btn-default btn-outline btn-xs js-window-load" title="详情--<?php echo $vo['serial_sn']; ?>"><i class="fa fa-edit fa-fw"></i><span class="hidden-xs">详情</span></a><a href="<?php echo U('Orders/del',['id'=>$vo['order_id']]); ?>" class="btn  btn-danger btn-outline btn-xs js-del-btn" text="删除后将无法恢复,请谨慎操作！"><i class="fa fa-trash-o fa-fw"></i><span class="hidden-xs">删除</span></a></span></td></tr><?php endforeach; endif; else: echo "" ;endif; ?></tbody></table></div><link id="tree_table_default" href="<?php echo $web_static; ?>/plugins/treetable/default/jquery.treeTable.css" rel="stylesheet" type="text/css" /><script src="<?php echo $web_static; ?>/plugins/treetable/jquery.treeTable.js" type="text/javascript"></script><script type="text/javascript">    //提交分页size
    function page_size(){
